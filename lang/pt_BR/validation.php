...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo contêm as mensagens de erro padrão usadas pelo
    | validador. Algumas regras têm várias versões, como as regras de
    | tamanho. Ajuste cada uma dessas mensagens conforme necessário.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode definir mensagens de validação personalizadas para
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo trocam o placeholder do atributo por algo mais legível,
